    ...
    in
      with pkgs; {
        packages = flake-utils.lib.flattenTree rec {
          TODO = rustPlatform.buildRustPackage rec {
            meta = with lib; {
              description = ''
                TODO
              '';
              homepage = "https://github.com/Isaac-DeFrain/TODO";
            ...
            '';
            preInstall = "mkdir -p $out/var/log/TODO";
          };
        ...
        #       paths = with pkgs; [TODO bash self];
        #       name = "TODO-root";
        #       pathsToLink = ["/bin" "/share"];
        #     };
        #     config.Cmd = ["${pkgs.lib.getExe TODO}"];
        #   };
        };
